const icons = {
    _iconBase(path, title = null, useTooltipInstead = false){
        const element = document.createElement('svg');
        element.setAttribute('xlmns', 'http://www.w3.org/2000/svg');
    ...
    close(title = null, useTooltipInstead = false) {
        ...
        return this.materialIcon(fromHTML(path), title, useTooltipInstead);
    },
    ...
    menu(title = null, useTooltipInstead = false) {
        ...
        return this.heroIcon(fromHTML(path), title, useTooltipInstead);
    },
